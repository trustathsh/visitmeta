...
public class CheckSavingTabbedPane extends JTabbedPane {
	...
	private static final Logger log = Logger
			.getLogger(CheckSavingTabbedPane.class);
	...
	public void setSelectedIndex(int index) {
		if (getSelectedComponent() != null
				&& getSelectedComponent() instanceof TabPanel) {
	...
	public void yesOption(Component selectedComponent)
			throws PropertyException, UniformInterfaceException, JSONException {
		if (selectedComponent instanceof DataServicePanel) {
			...
			try {
				...
				log.error("Error while updating the Dataservice-Connection("
						+ tmp.getName() + ")", e);
				// rollBack
