...
public class GraphDeleteFourthTest extends AbstractMultiSubscriptionTestCase {
	...
	private List<ResultItem> buildStartingGraphResultItems() {
		...
		ResultItemMock resultItem6_mock = new ResultItemMock(identifierDEV, identifierIP);
		...
		resultItem6_mock.addDevIp(FIRST_TIMESTAMP);
