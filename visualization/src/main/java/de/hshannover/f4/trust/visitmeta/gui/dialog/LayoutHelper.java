...
public class LayoutHelper {
	...
	public static final Insets NULL_INSETS = new Insets(0, 0, 0, 0); // no free space

	public static final Insets LABEL_INSETS = new Insets(2, 5, 2, 2); // label distances

	public static final Insets INPUT_INSETS = new Insets(0, 10, 0, 10); // Input components Clearances
	...
	public static void addComponent(int x, int y, int width, int height, double weightX, double weightY,
			Container container, Component component, Insets insets) {
