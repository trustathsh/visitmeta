...
/**
 * Simple filter by checking the getTypeName() of each identifier.
 * Just filtering the identifiers.
 * 
 * @author Johannes Busch
 *
 */
public class IdentifierFilter extends GenericElementFilter<Identifier> {
	...
	/**
	 * Simple filter method which filters the given list
	 * against the specified filters.
	 */
	@Override
