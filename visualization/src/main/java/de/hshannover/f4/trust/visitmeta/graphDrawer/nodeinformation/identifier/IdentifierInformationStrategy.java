...
/**
 * Abstract superclass for classes that create the text for {@link Identifier} elements within the graphical
 * representation.
 *
...
public abstract class IdentifierInformationStrategy {
	...
	protected final Properties mConfig = Main.getConfig();
	 ...
	 *
	 * @param identifier
	 *            the {@link Identifier} for creating the text
