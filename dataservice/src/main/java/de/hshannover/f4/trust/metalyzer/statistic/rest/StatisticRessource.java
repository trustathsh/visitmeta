...
public class StatisticRessource implements StatisticFacade {
    ...
    public String evaluateMean(@PathParam("from") long from,@PathParam("to") long to,@PathParam("filter") StandardIdentifierType filter, @PathParam("type") MeanType type) {
		try {
			statisticController.setConnection(connectionName);
			return new Gson().toJson(statisticController.evaluateMean(from, to, filter, type));
		} catch (MetalyzerAPIException e) {
			Logger.getLogger(StatisticRessource.class.getName()).log(Level.SEVERE, null, e);
		}
		return null;
	}
    ...
    @Produces(MediaType.TEXT_PLAIN)
    public String evaluateFrequency(@PathParam("from") long from, @PathParam("to") long to,
    		@PathParam("type") FrequencyType type, @PathParam("selection") FrequencySelection selection) {
    	try {
    		statisticController.setConnection(connectionName);
			return gson.toJson(statisticController.evaluateFrequency(from, to, type, selection));
		} catch (MetalyzerAPIException e) {
			Logger.getLogger(StatisticRessource.class.getName()).log(Level.SEVERE, null, e);
		}
		return null;
    ...
    @Produces(MediaType.TEXT_PLAIN)
	public String sumOfMetadata(@PathParam("from") long from, @PathParam("to") long to) {
        try {
        	statisticController.setConnection(connectionName);
    ...
    @Produces(MediaType.TEXT_PLAIN)
    public String sumOfIdentifier(@PathParam("from") long from, @PathParam("to") long to) {
        try {
        	statisticController.setConnection(connectionName);
	...
	public String getEdgeCharecteristic(@PathParam("from") long from, @PathParam("to")  long to) {
		statisticController.setConnection(connectionName);
	...
	@Produces(MediaType.TEXT_PLAIN)
	public String getMeanOfEdgeCharecteristic(@PathParam("from") long from, @PathParam("to") long to) {
		statisticController.setConnection(connectionName);
    	return gson.toJson(statisticController.getMeanOfEdgeCharecteristic(from, to));
	}
    ...
    @Produces(MediaType.TEXT_PLAIN)
	public String getNodeCharecteristic(@PathParam("from") long from, @PathParam("to")  long to) {
    	statisticController.setConnection(connectionName);
    ...
    @Produces(MediaType.TEXT_PLAIN)
	public String rateOfChange(@PathParam("from") long from, @PathParam("to") long to, @PathParam("type") StandardIdentifierType type) {
    	statisticController.setConnection(connectionName);
    ...
    @Produces(MediaType.TEXT_PLAIN)
	public String rateOfChange(@PathParam("from") long from, @PathParam("to") long to, @PathParam("type") String type) {
		statisticController.setConnection(connectionName);
		return gson.toJson(statisticController.rateOfChange(from, to, type));
	}
    ...
    @Produces(MediaType.TEXT_PLAIN)
	public String rateOfChange(@PathParam("from") long from, @PathParam("to") long to) {
		statisticController.setConnection(connectionName);
	...
	public String relationOfNodesToLinks(@PathParam("timestamp") long timestamp) {
		statisticController.setConnection(connectionName);
		return gson.toJson(statisticController.relationOfNodesToLinks(timestamp));
	}
    ...
    @Produces(MediaType.TEXT_PLAIN)
	public String evaluateMean(@PathParam("filter")StandardIdentifierType filter,@PathParam("type") MeanType type) {
		statisticController.setConnection(connectionName);
    ...
    @Produces(MediaType.TEXT_PLAIN)
	public String evaluateMean(@PathParam("timestamp")long timestamp,@PathParam("filter") StandardIdentifierType filter, @PathParam("type")MeanType type) {
		statisticController.setConnection(connectionName);
		return gson.toJson(statisticController.evaluateMean(timestamp, filter, type));
	}
    ...
    @Produces(MediaType.TEXT_PLAIN)
	public String evaluateFrequency(@PathParam("type")FrequencyType type, @PathParam("selection")FrequencySelection selection) {
		statisticController.setConnection(connectionName);
		return gson.toJson(statisticController.evaluateFrequency(type, selection));
	}
    ...
    @Produces(MediaType.TEXT_PLAIN)
	@Override
	public String evaluateFrequency(@PathParam("timestamp")long timestamp,	@PathParam("type")FrequencyType type,@PathParam("selection") FrequencySelection selection) {
		statisticController.setConnection(connectionName);
		return gson.toJson(statisticController.evaluateFrequency(timestamp,type, selection));
	}
