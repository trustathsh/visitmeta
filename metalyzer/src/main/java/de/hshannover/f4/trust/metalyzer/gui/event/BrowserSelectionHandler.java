...
public class BrowserSelectionHandler extends MouseAdapter {
	...
	public BrowserSelectionHandler(JTree tree, MetalyzerGuiController guiController) {
		this.mTree = tree;
	...
	public void mousePressed(MouseEvent e) {
		if(e.getClickCount() == 2) {
			...
			if (mSelectionPath != null) {
				DefaultMutableTreeNode selectedNode = (DefaultMutableTreeNode) mSelectionPath.getLastPathComponent();
