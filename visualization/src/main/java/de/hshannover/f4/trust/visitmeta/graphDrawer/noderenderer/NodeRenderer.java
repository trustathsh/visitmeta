...
public interface NodeRenderer {
	...
	void paintMetadataNode(Metadata metadata, NodeMetadata m, GraphicWrapper graphic);

	void paintIdentifierNode(Identifier identifier, NodeIdentifier i, GraphicWrapper graphic);
