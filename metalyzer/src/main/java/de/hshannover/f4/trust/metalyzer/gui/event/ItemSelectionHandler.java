...
public class ItemSelectionHandler implements ActionListener{
	...
	public ItemSelectionHandler(MetalyzerGuiController guiControl, SemanticPanel semanticPanel) {
		mGuiControl = guiControl;
		mSemanticPanel = semanticPanel;
	}
	
	/**
	 * Triggers a ActionEvent, which fills the {@link SemanticPanel} according to the selected user
