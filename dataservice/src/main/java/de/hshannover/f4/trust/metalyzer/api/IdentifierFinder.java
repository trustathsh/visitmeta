 ...
 * 
 * Interface fuer die IdentifierFinder Klasse. 
...
public interface IdentifierFinder {
	 ...
	 * @param filter given identifier filter.
	 * @return
	 * @throws MetalyzerAPIException
	 */
	 ...
	 * @throws MetalyzerAPIException
	 */
	public Collection<Identifier> get(StandardIdentifierType filter, long timestamp);
	 ...
	 * @throws MetalyzerAPIException
	 */
	public MetalyzerDelta<Identifier> get(StandardIdentifierType filter, long from, long to);
