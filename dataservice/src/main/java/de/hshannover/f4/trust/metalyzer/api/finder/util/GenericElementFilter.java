...
/**
 * Abstract super class which defines filter methods for the
 * elements filters.
 *
 * @author Johannes Busch
 */
public abstract class GenericElementFilter<T> {
	...
	/**
	 * Returns a copy of the filtered list and erases the internal list.
	 * This filter can be used several times without creating new filter objects.
	 * @return
	 */
