...
import de.hshannover.f4.trust.visitmeta.gui.nodeinformation.NodeInformationStrategyFactor;
...
public class PanelXmlTree extends JScrollPane {
	...
	public PanelXmlTree() {
		...
		mNodeInformationStrategy = NodeInformationStrategyFactor.create(NodeInformationStrategyType.XML_BREAKDOWN);	// TODO read from configuration file
	...
	public void fill(Propable pData) {
		...
		DefaultMutableTreeNode vRoot = mNodeInformationStrategy.createNodeInformation(pData);
