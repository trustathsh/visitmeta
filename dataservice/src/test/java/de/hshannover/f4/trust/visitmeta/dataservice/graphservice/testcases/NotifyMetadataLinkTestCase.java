...
public class NotifyMetadataLinkTestCase extends AbstractTestCase {
	private final String TESTCASE_FILENAME = TESTCASES_DIRECTORY + File.separator + "NotifyMetadataLink.yml";
	...
	public void getNotifiesAt1() throws Exception {
		...
		JSONArray expected = new JSONArray();
		{
			JSONObject idPair1 = createJSONIdentifierMetadataConnection("device1", "device2", "event2");
			JSONObject subGraph1 = createJSON(timestamp, idPair1);
			expected.put(subGraph1);
		}
