...
public class GraphDeleteSecondTest extends AbstractMultiSubscriptionTestCase {
	...
	public void shouldReturnTheRightChangeMapChangeValue() {
		...
		super.assertEqualsNewValues(mFirstChangesMap, mSecondChangesMap, 2);
	}
	...
	private List<ResultItem> buildSub2DeleteResultItem() {
		Identifier identifierAR = Identifiers.createAr("ARMultiSubscriptionTest");
	...
	private ResultItem buildSub3DeleteResultItem() {
	...
	private PollResult buildDeletePollResult() {
		...
		List<ResultItem> resultItemSub2 = buildSub2DeleteResultItem();
		ResultItem resultItemSub3 = buildSub3DeleteResultItem();
		...
		SearchResultMock searchResult3_mock = new SearchResultMock(Type.deleteResult);
		searchResult3_mock.addResultItem(resultItemSub3);
		...
		pollResult_mock.addSearchResult(searchResult3_mock.getMock());
	...
	private List<ResultItem> buildStartingGraphResultItems() {
		...
		Identifier identifierMAC2 = Identifiers.createMac("11:22:33:44:55:66");
		Identifier identifierMAC3 = Identifiers.createMac("22:33:44:55:66:77");
		Identifier identifierMAC4 = Identifiers.createMac("aa:bb:cc:dd:ee:ff");
		Identifier identifierDEV = Identifiers.createDev("DEV45");
		...
		ResultItemMock resultItem4_mock = new ResultItemMock(identifierAR, identifierDEV);
		ResultItemMock resultItem5_mock = new ResultItemMock(identifierAR);
		ResultItemMock resultItem6_mock = new ResultItemMock(identifierMAC4);
		...
		resultItem5_mock.addArDev(FIRST_TIMESTAMP);
		resultItem5_mock.addCapability("CAP1", FIRST_TIMESTAMP);
		resultItem6_mock.addCapability("CAP2", FIRST_TIMESTAMP);
		...
		resultItems.add(resultItem4_mock.getMock());
		resultItems.add(resultItem5_mock.getMock());
		resultItems.add(resultItem6_mock.getMock());
