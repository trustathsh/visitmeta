...
public class ProxyUserService implements UserService {
	...
	public ProxyUserService(AsyncWebResource analyseRessource) {
		this.mAnalyseRessource = analyseRessource.path("semantics").path("user");
		mGson = new Gson();
	}
	...
	public ArrayList<User> getAllUsers(long timestamp) throws InterruptedException, ExecutionException, TimeoutException {
		...
		if(status == Status.OK) {
			...
			MessageBox.showErrorOutputDialog(status.getReasonPhrase(),"No users for timestamp "+UtilHelper.convertTimestampToDatestring(timestamp) + " were found", error);
		}
		return users;
	}
	...
	public ArrayList<User> getAllUsersFromTo(long fromTimestamp, long toTimestamp) throws InterruptedException, ExecutionException, TimeoutException {
		...
		if(status == Status.OK) {
			...
			MessageBox.showErrorOutputDialog(status.getReasonPhrase(),
					"No Users for time intervall "+UtilHelper.convertTimestampToDatestring(fromTimestamp)+" "+UtilHelper.convertTimestampToDatestring(toTimestamp)+" were found", error);
		}
		return users;
	}
	...
	public ArrayList<User> getCurrentUsers() throws InterruptedException, ExecutionException, TimeoutException {
		...
		if(status == Status.OK) {
			...
			String error = mClientResponse.getEntity(String.class);
			MessageBox.showErrorOutputDialog(status.getReasonPhrase(),"No users for the current timstamp were found", error);
		}
		return users;
	}
	...
	public long getTimestampForUser(User user) throws InterruptedException, ExecutionException, TimeoutException {
		...
		if(status == Status.OK) {
			...
			String error = mClientResponse.getEntity(String.class);
			MessageBox.showErrorOutputDialog(status.getReasonPhrase(),"No timestamp for user "+user.getName()+" was found", error);
		}
		return timestamp;
	}
	...
	public ArrayList<IpAddress> getIpAddressesForUser(User user) throws InterruptedException, ExecutionException, TimeoutException {
		...
		if(status == Status.OK) {
			...
			String error = mClientResponse.getEntity(String.class);
			MessageBox.showErrorOutputDialog(status.getReasonPhrase(),"No ipaddresses for user "+user.getName()+" were found", error);
		}
		return ipaddresses;
	}
	...
	public ArrayList<MacAddress> getMacAddressesForUser(User user) throws InterruptedException, ExecutionException, TimeoutException {
		...
		if(status == Status.OK) {
			...
			String error = mClientResponse.getEntity(String.class);
			MessageBox.showErrorOutputDialog(status.getReasonPhrase(),"No macaddresses for user "+user.getName()+" were found", error);
		}
		return macaddresses;
	}
	...
	public ArrayList<Device> getDevicesForUser(User user) throws InterruptedException, ExecutionException, TimeoutException {
		...
		if(status == Status.OK) {
			...
			String error = mClientResponse.getEntity(String.class);
			MessageBox.showErrorOutputDialog(status.getReasonPhrase(),"No devices for user "+user.getName()+" were found", error);
		}
		return devices;
	}
